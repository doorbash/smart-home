...
public class AddMusicPlayer extends Dialog {
...
//    EditText channelNo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_add_music_player);
