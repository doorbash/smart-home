...
public class Command {
    ...
    public Command setTarget(int subnetID, int deviceID) {
        this.targetSubnetID = subnetID;
    ...
    public String toString() {
        return ip + " " + subnetID + " " + deviceID + " " + deviceType + " " + operationCode + " " + targetSubnetID + " " + targetDeviceID;
    }
    ...
    public byte[] output() {
        ...
        try {
            ...
            byte[] output = new byte[payload == null ? 27 : 27 + payload.length];
            ...
            int length = payload == null ? 11 : (11 + payload.length);
